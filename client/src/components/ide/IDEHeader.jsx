...
import { Play, Save, Terminal, CheckCircle2, ArrowLeft, PanelBottom, Palette } from 'lucide-react';
...
export function IDEHeader({ 
  ...
  return (
    <div className="h-12 bg-bg-deep border-b border-border-main px-4 flex items-center justify-between select-none font-mono text-xs">
      <div className="flex items-center gap-3">
        <Link 
          to="/workspace" 
          className="flex items-center gap-1.5 text-text-muted hover:text-brand-primary transition-colors py-1 px-2 rounded-lg hover:bg-surface-elevated"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-text-primary max-w-[150px] sm:max-w-[200px] truncate">
          ...
          <div className="flex items-center gap-1 text-[11px]">
            {isSaving ? (
              ...
              <span className="text-status-warning font-semibold">Unsaved Changes</span>
            ) : (
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`px-2.5 py-1.5 rounded-lg border font-bold flex items-center gap-1.5 transition-colors cursor-pointer ${
            isBottomOpen 
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-surface-elevated hover:bg-surface border border-border-main text-text-primary font-bold flex items-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
        ...
        <button
          onClick={onRun}
          disabled={isRunning}
          className="px-4 py-1.5 rounded-lg bg-brand-primary hover:bg-brand-hover text-bg-deep font-bold flex items-center gap-1.5 transition-all shadow-md cursor-pointer disabled:opacity-50"
        >
