...
function parseLineTokens(text, lang) {
  ...
  const keywordsMap = {
    ...
    react: new Set(['import', 'export', 'default', 'from', 'const', 'let', 'var', 'function', 'return', 'useState', 'useEffect', 'useContext', 'useRef', 'useMemo', 'useCallback', 'useReducer', 'React', 'ReactDOM', 'div', 'span', 'button', 'input', 'h1', 'h2', 'h3', 'p', 'form', 'className', 'onClick', 'onChange', 'true', 'false', 'null', 'undefined']),
    jsx: new Set(['import', 'export', 'default', 'from', 'const', 'let', 'var', 'function', 'return', 'useState', 'useEffect', 'useContext', 'useRef', 'useMemo', 'useCallback', 'useReducer', 'React', 'ReactDOM', 'div', 'span', 'button', 'input', 'h1', 'h2', 'h3', 'p', 'form', 'className', 'onClick', 'onChange', 'true', 'false', 'null', 'undefined']),
    kotlin: new Set(['package', 'import', 'fun', 'val', 'var', 'class', 'object', 'interface', 'data', 'sealed', 'when', 'if', 'else', 'for', 'while', 'return', 'null', 'true', 'false', 'override', 'private', 'public', 'protected', 'internal', 'companion', 'suspend', 'is', 'as', 'in', 'println', 'List', 'Map', 'Set']),
    swift: new Set(['import', 'func', 'var', 'let', 'class', 'struct', 'enum', 'protocol', 'extension', 'if', 'else', 'guard', 'switch', 'case', 'for', 'in', 'while', 'return', 'true', 'false', 'nil', 'public', 'private', 'internal', 'override', 'async', 'await', 'try', 'catch', 'print', 'Self', 'self', 'String', 'Int', 'Double', 'Bool'])
  };
